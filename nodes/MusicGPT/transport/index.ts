...
export async function apiRequest(
    ...
    const baseUrl = process.env.API_BASE_URL || 'https://api.musicgpt.com';
    ...
    try {
        const response = await this.helpers.requestWithAuthentication.call(this, 'musicGPTApi', options);
        return response;
    } catch (error: any) {
        throw error;
    }
